...
export TRAIN_FILE=${TRAIN_FILE:-"${VERL_HOME}/data/dapo-math-unique-17k.parquet"}
export TEST_FILE=${TEST_FILE:-"${VERL_HOME}/data/aime-2024.parquet"}

mkdir -p "${VERL_HOME}/data"

wget -O "${TRAIN_FILE}" "https://huggingface.co/datasets/tongyx361/DAPO-Math-Unique-17k/resolve/main/data/dapo-math-unique-17k.parquet?download=true"
