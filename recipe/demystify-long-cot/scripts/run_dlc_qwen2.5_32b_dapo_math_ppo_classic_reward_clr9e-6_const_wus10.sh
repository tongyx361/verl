...
exp_name="qwen2.5-32b-dlc-classic-reward-dapo-math-ppo-clr9e-6-const-wus10-${num_procs}gpus"
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/dapo-math-unique-boxed-17k.parquet"}
