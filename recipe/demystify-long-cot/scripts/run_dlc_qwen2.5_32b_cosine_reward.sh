...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    reward_manager.enable_cosine_length_scaling_reward=${enable_cosine_length_scaling_reward} \
    reward_manager.correct_cosine_max_reward=${correct_cosine_max_reward} \
    reward_manager.correct_cosine_min_reward=${correct_cosine_min_reward} \
    reward_manager.wrong_cosine_max_reward=${wrong_cosine_max_reward} \
    reward_manager.wrong_cosine_min_reward=${wrong_cosine_min_reward} \
