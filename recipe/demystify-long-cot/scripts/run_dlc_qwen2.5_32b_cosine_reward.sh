...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    reward_manager.cosine_length_scaling.enabled=${enable_cosine_length_scaling_reward} \
    reward_manager.cosine_length_scaling.correct_reward.max=${correct_cosine_max_reward} \
    reward_manager.cosine_length_scaling.correct_reward.min=${correct_cosine_min_reward} \
    reward_manager.cosine_length_scaling.wrong_reward.max=${wrong_cosine_max_reward} \
    reward_manager.cosine_length_scaling.wrong_reward.min=${wrong_cosine_min_reward} \
    reward_manager.exceeding_reward=${exceeding_reward} \
