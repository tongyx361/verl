...
from verl.trainer.config.ppo_dp_trainer import PPO_DP_TRAINER_CONFIG_NAME, PPODPTrainerConfig
...
@hydra.main(version_base=None, config_name=PPO_DP_TRAINER_CONFIG_NAME)
def main(config: PPODPTrainerConfig):
