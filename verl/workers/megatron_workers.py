...
from verl.utils.model import load_mcore_dist_weights, load_megatron_gptmodel_weights, load_megatron_model_weights
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(
        ...
        from verl.utils.megatron_utils import convert_config, get_model, init_megatron_optim_config
